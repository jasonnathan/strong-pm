...
var minke_config_options = require('./minke_config.json')
...
function Server(originalCommand, baseDir, listenPort, controlPath) {
 ...
 // set up minkelite
  minke_config_options.port = this._listenPort
  this._app.use(MinkeLite(minke_config_options).get_express_app());
